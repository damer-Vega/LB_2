/**
 * @file main.cpp
 * @brief Главный файл программы для обработки массива чисел из файла.
 *
 * Этот файл содержит код для чтения массива чисел из входного файла,
 * выполнения заданной операции (сортировка, реверс или перестановка чётных и нечётных элементов),
